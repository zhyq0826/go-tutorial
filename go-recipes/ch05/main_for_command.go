...
func main() {
	fileName := flag.String("filename", "logfile", "filename for log file")
	logLevel := flag.Int("loglevel", 0, "An integer value for loglevel 0-4")
	...
	// -filename=applog -loglevel=2 -enable -num=50 10 20 30 test
}
